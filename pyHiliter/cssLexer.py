...
class CssLexer(RegexLexer):
    ...
    tokens = {
        ...
        'atrule': [
            (r'[\s\n]+', Text),
            (r'/\*(?:.|\n)*?\*/', Comment),
            (r'\(', Punctuation, 'atrulecond'),
            (r'\{', Punctuation, 'atcontent'),
            (r';', Punctuation, '#pop'),
            (r'('+r'|'.join(_keyword_values)+r')(\s+)',
        ...
        'atrulecond':[
            (r'\)', Punctuation, '#pop'),
            (r'([\w-]+)(\:)([\s\n]*)', bygroups(Keyword.Type, Punctuation, Text)),
            include('numeric-values'),
            (words(_css_properties), Name.Builtin),
            (r'[\w-]+', Name)
        ],
        'atcontent': [
            (r'(font-family)(\s*)(\:)(\s*)([\'"]?[\w\s-]*[\'"]?)(;)', bygroups(Keyword.Type.Yo, Text, Punctuation, Text, String, Punctuation)),
            (r'([\w-]+)(\s*)(\:)',
                 bygroups(Keyword.Type, Text, Punctuation.Key), 'value-start'),
            include('basics'),
            (r'\}', Punctuation, '#pop:2'),
        ],
        'content': [
            ...
            (r'('+r'|'.join(_css_properties)+r')(\s*)(\:)',
             bygroups(Keyword.Type, Text, Punctuation), 'value-start'),
        ...
        'urls': [
            (r'(url|url-prefix|domain|regexp)(\()(".*?")(\))', bygroups(Name.Builtin, Punctuation,
        ...
        'numeric-end': [
            (words(_all_units, suffix=r'\b'), Keyword),
            (r'%', Operator),
            default('#pop'),
        ],
    }
